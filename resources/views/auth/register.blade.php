...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Go</b>Blockchain</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('linkedin') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="linkedin" value="{{ old('linkedin') }}" placeholder="Perfil Linkedin">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
        ...
        <a href="{{ url('/login') }}" class="text-center">Eu já tenho conta</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
